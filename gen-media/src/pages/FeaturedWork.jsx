function FeaturedWork() {
  ...
  return (
    <section
      id="portfolio"
      className="bg-[#F8F6F1] text-[#2C2C2C] pt-2 pb-16"
    >
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-xl text-[#2C2C2C]/40 group-hover:text-[#FF9800] transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1">
